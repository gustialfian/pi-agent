...
5. Once you have a complete understanding of the problem and solution, use the template below to write the PRD. Ask the user for where The PRD should be written.
